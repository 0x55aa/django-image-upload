...
DATABASES = {
    'default': {
        ...
        'NAME': 'image',                      # Or path to database file if using sqlite3.
...
STATICFILES_DIRS = (
	...
	os.path.join(os.path.dirname(os.path.dirname(__file__)),'static').replace('\\','/'),
        os.path.join(os.path.dirname(os.path.dirname(__file__)),'media').replace('\\','/'),
)
...
SECRET_KEY = '^h8sua(y@do0opo#dwn8pv5t-e#+q^4+zd_=h_+fo$=v5=y+m-'
